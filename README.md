...
1. What problem does the context API help solve?
  ...
  Context provides a way to pass data through the component tree without having to pass props down manually at every level. It is a jsx version similar to redux

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

  The store will contain the class and the action handler. Reducer however will be where the inital state is set and how the action type is returned.


3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

  Application state is global and component state is Global with the component state however, it lives within that specific component. It can only be updated within that component and passed down to its children via props.
...
5. What is your favorite state management system you've learned and this sprint? Please explain why!
  ...
  I really like context api. It is really easy to do. However I think redux is a very dynamic way of holding global state. 
